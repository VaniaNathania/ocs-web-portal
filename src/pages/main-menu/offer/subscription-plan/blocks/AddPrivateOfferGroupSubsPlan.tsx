...
interface AddPrivateOfferGroupSubsPlanProps {
  isOpen: boolean;
  onClose: () => void;
...
const AddPrivateOfferGroupSubsPlan: React.FC<
  AddPrivateOfferGroupSubsPlanProps
> = ({ isOpen, onClose, onSubmit, group, isPublic = false, type = "1" }) => {
  ...
  const onConfirm = async () => {
    try {
      // console.log(group, selectedSubSubPlan, selectedVer, servType);
      ...
      // console.log(submitData, selectedSubSubPlan, formData);
...
export default AddPrivateOfferGroupSubsPlan;
