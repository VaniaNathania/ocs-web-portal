...
import { FeatureData } from "../../main-product/components/DetailCategoryContent/FeatureTabContent";
...
interface AddShowFeatureDialogProps {
  ...
  offerId?: string;
  onSuccess?: () => void;
  initialSelectedFeature? : FeatureData[];
}

const API_URL_OFFER = apiConfigOffer.offer;

const AddShowFeatureDialog: React.FC<AddShowFeatureDialogProps> = ({ isOpen: externalIsOpen, onClose, onOpenChange: externalOnOpenChange, onAdd, offerId, initialSelectedFeature }) => {
  ...
  const loadDataSelectedFeature = async (offerId: string) => {
    try {
      ...
      if (response?.data && Array.isArray(response.data)) {
        ...
        console.warn("⚠️ No selected data or invalid data format:", response);
        setSelectedFeatures([]);
