...
import { SubscriptionUpdateAcmFormType } from "../EditPriceDialog";
// import { SubscriptionUpdatePriceRatingForm } from "./EditPriceDialog";
...
const ExpressionPrice = ({ scriptToChange }: { scriptToChange?: string }) => {
  ...
  const { setValue, watch } =
    useFormContext<SubscriptionUpdateAcmFormType>();
