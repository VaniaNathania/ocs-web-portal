...
import { TcelBalanceAdjustmentLayoutProvider, Main } from "./";

const TcelBalanceAdjustmentLayout = () => {
  ...
  return (
    ...
    <TcelBalanceAdjustmentLayoutProvider>
      <Main />
    </TcelBalanceAdjustmentLayoutProvider>
  );
};

export { TcelBalanceAdjustmentLayout };
export default TcelBalanceAdjustmentLayout;
