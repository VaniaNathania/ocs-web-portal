...
import { OfferGroupDataNew } from "../../subscription-plan/components/DetailCategoryContent/OfferGroupContentSubsPlanDrop";
...
import SubscriptionPlanSectionPublicOfferGroup from "../../subscription-plan/components/PublicOfferGroupSubsPlanContentChild";
                ...
                {partys?.map((item, index) => {
                  ...
                  const handleSelectGroup = () => {
                    if (item.offerGroupId !== selectedGroup?.offerGroupId) {
                      ...
                      setTimeout(
                        () => scrollToItem(String(item.offerGroupId)),
                        50,
                      );
                    }
                  ...
                  <div className="flex items-center space-x-2 w-1/2">
                    ...
                    <div className="flex w-1/2 space-x-2">
                      ...
                      <Select
                        ...
                        onValueChange={(val) =>
                          setFormEdit((prev) => ({ ...prev, timeUnit: val }))
                        }
                        disabled={!isEditing}
                      >
                        <SelectTrigger>
