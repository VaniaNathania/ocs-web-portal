...
import { agreementPeriod } from "../types";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const BelongOfferGroup: React.FC<BelongOfferGroupData> = ({ category, rowData }) => {
...

      {
        ...
        cell: ({ row }) => {
          ...
          if (isEditing) {
            return (
              <Select
                value={editingRow.defaultFlag ?? undefined}
          ...
          <DialogHeader className="p-0 border-0 block">
            <Alert variant="warning">
              ...
              <span className="text-sm">
                You will delete the Belong in offer group"{selectedRowToDelete?.offerGroupName}"
              </span>
            </Alert>
          </DialogHeader>
