...
const CategoryDetailModal: React.FC<CategoryDetailModalProps> = ({
  ...
  const { setRefreshOfferListSidebar, selectedCategoryId } =
  ...
  const fetchDetailCategoryContent = async (offerId: string) => {
    ...
    try {
      const response = await GetData(
        `${API_URL_OFFER}/offer/indep/qry-indep-prod-spec-by-offer-id`,
        params,
      );
      ...
      if (response?.status && response?.data) {
        ...
        // Setup form data untuk edit mode
        ...
        const newFormData: FormData = {
          ...
          lifecycleType: dataObject.lifecycleType
            ? String(dataObject.lifecycleType)
            : "",
          offerCatgId: dataObject.offerCatgId || "",
          prodType: dataObject.prodType || "",
        };

        //  console.log("KOCAK", newFormData);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await PutData(
        `${API_URL_OFFER}/offer/indep/mod-indep-prod-spec`,
        payloadToSend,
      );
      ...
      if (response?.status) {
        ...
        const errorMessage =
          response?.message || "Failed to update Related Product";
  ...
  const handleInputChange = (field: string, value: any) => {
    setFormData((prev) => {
      ...
      if (field.startsWith("offer.")) {
        const offerField = field.replace(
          "offer.",
          "",
        ) as keyof FormData["offer"];
        ...
        <div className="flex-1 p-6 overflow-y-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-5">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-[auto_auto_1fr] gap-x-2 items-start">
                        ...
                        <span className="text-sm text-gray-900">
                          {serviceType.find(
                            (item) => item.servType === detailContent?.servType,
                          )?.servTypeName || "-"}
                        </span>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-[auto_auto_1fr] gap-x-2 items-start">
                        ...
                        <span className="text-sm text-gray-900">
                          {MapDisplayData(detailContent).effectiveTypeDisplay ||
                            "-"}
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-[auto_auto_1fr] gap-x-2 items-start">
                        ...
                        <span className="text-sm text-gray-900">
                          {MapDisplayData(detailContent).paidFlagDisplay || "-"}
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-[auto_auto_1fr] gap-x-2 items-start">
                        ...
                        <span className="text-sm text-gray-900">
                          {detailContent?.brandPricePlanId ||
                            rowData?.brandPricePlanId ||
                            "-"}
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-[auto_auto_1fr] gap-x-2 items-start">
                        ...
                        <span className="text-sm text-gray-900">
                          {MapDisplayData(detailContent).productLineDisplay ||
                            "-"}
                        </span>
                      </div>
          ...
          {activeTab === "relationship" && (
            <RelationshipTabContent            
              rowData={detailContent || rowData}
              allowedRelationTypes={["Exchangeable"]}
            />
          )}

          {activeTab === "private-offer-group" && <PrivateOfferGroupContent />}
...
export const useEditModalHandlers = () => {
  ...
  const handleEditOpen = (category: string, rowData: any) => {
    //  console.log("🖊️ Opening edit modal for:", category, "with data:", rowData);
  ...
  const handleEditSave = (
    ...
    //  console.log("✅ Edit data successfully saved");
  };
