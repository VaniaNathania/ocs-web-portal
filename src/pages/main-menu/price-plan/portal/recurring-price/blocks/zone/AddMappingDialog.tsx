...
type RecurringCreateMappingForm = z.infer<typeof recurringCreateMappingSchema>;
...
const AddMappingDialog = () => {
  ...
  const methods = useForm<RecurringCreateMappingForm>({
    resolver: zodResolver(recurringCreateMappingSchema),
    defaultValues,
  });
  ...
  const DoCreateMapping = async (data: RecurringCreateMappingForm) => {
  ...
  const onSubmit = async (data: RecurringCreateMappingForm) => {
