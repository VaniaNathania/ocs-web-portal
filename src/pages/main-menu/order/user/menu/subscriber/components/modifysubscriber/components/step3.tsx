...
import { CashDeskFee, QryDefaultBAL } from "../model/interfaces";
...
const ModSubsStep3 = () => {
  ...
  useEffect(() => {
    ...
    console.log("cash + payment", amount.balance + amount.cash);
  }, [amount]);
    ...
    <div className="flex flex-col w-full gap-2 p-5">
      ...
      <div className="flex flex-row h-[40px] bg-primary-clarity text-sm items-center justify-between py-2 px-4">
        ...
        <div className="flex flex-row gap-2">
          ...
          <div className="text-orange-400">
            {formatAmount(
              (Number(amount.cash) + Number(amount.balance)) * 100000,
            )}
          </div>
        </div>
        <div className="flex flex-row gap-2">
