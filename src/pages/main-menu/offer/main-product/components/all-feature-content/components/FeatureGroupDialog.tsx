...
const FeatureGroupDialog: React.FC<FeatureGroupDialogProps> = ({ isOpen, onClose, rowData }) => {
  ...
  return (
    <>
      ...
      <AddFeatureGroupMemDialog isOpen={isAddDialogOpen} onClose={() => setIsAddDialogOpen(false)} onAdd={handleAddFeature} offerId={offerId} onSuccess={() => setReloadKey((prev) => prev + 1)} />
    </>
  );
};
