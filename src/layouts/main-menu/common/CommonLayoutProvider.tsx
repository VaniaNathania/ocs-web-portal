...
import { MENU_DASHBOARD, MENU_SIDEBAR } from "@/config";
...
// Initial layout provider properties, using  layout configuration as the default
...
const useCommonLayout = () => useContext(LayoutContext);
...
const LayoutProvider = ({ children }: PropsWithChildren) => {
  ...
  setMenuConfig("primary", MENU_DASHBOARD);
...
export { LayoutProvider, useCommonLayout };
