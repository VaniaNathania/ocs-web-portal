...
type ListToolBarProps = {
  ratePlanId: number;
  priceRating: PriceDetail;
};

const API_URL = apiConfig.service_assets;

const ListToolBar = ({ ratePlanId, priceRating }: ListToolBarProps) => {
  const {
        ...
        <div className="flex justify-between w-full items-center">
          <div className="w-[80%] flex gap-3 items-center">
            <Button
              ...
              onClick={() => {
                handlePriceVersionDialog(true, "price", "create", priceRating);
                setSelectedPriceVer(priceRating);
              }}
            >
              Add Data
            </Button>
