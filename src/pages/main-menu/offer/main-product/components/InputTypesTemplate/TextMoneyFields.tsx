...
interface TextMoneyFieldsProps {
  formData: any;
  onChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => void;
  isEditingMode: boolean;
}

const TextMoneyFields: React.FC<TextMoneyFieldsProps> = ({ formData, onChange, isEditingMode }) => {
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="grid grid-cols-[160px_1fr] items-center gap-4">
          ...
          {isEditingMode ? (
            ...
            <span className="text-sm font-medium text-gray-800">{formData.ruleScript || null}</span>
          )}
        </div>
      </div>
...
export default TextMoneyFields;
