...
import { FormData } from "../all-feature-content/components/FeatureAddForm";
import { Button } from "@/components/ui/button";
import RegularExpressionDialog from "../all-feature-content/blocks/RegularExpressionDialog";

interface TextFloatFieldsProps {
  formData: any;
  onChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => void;
  isEditingMode: boolean;
}

const TextFloatFields: React.FC<TextFloatFieldsProps> = ({ formData, onChange, isEditingMode }) => {
...
export default TextFloatFields;
