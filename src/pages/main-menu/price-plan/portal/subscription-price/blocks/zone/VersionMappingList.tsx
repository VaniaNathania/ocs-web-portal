...
const VersionMappingList = ({
  ...
  const sortedMappings = [...(mappingRatingLists[plan.ratePlanId] || [])].sort(
  ...
  const renderMapping = () =>
    sortedMappings.map((mapping, idx) => {
      ...
      const isLoadingRating = loadingVersions[mapping.mappingId] || false;
      ...
      const mappingRating = mappingRatingLists[mapping.mappingId] || [];
      const isLoadingMappingRating =
        loadingMappingRating[mapping.mappingId] || false;
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3 items-center">
              ...
              <Button
                ...
                onClick={() => {
                  handleDeleteDialog(true, mapping.mappingId, "mappingRating");
                }}
              >
                <KeenIcon icon="trash" />
              </Button>
