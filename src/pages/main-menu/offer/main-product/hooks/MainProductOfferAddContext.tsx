...
const MainProductOfferAddContextProvider = ({
  children,
}: {
  ...
  const doCreateCredit = useCallback(
    ...
    <div className="flex justify-center">
      ...
      <div className="px-5 lg:w-9/12 w-full" style={{ marginTop: "-1.25rem" }}>
          ...
          <div className="flex items-center">
            <DefaultTooltip title="Back to list" placement="top">
              ...
              >
                <KeenIcon
                  icon="arrow-left"
                  className="text-[20px] px-1 card-title"
                />
              </Button>
            </DefaultTooltip>
            <p className="font-semibold text-[16px] card-title">
              Asset Management
            </p>
          </div>
        </div>
        ...
        {activeStep === steps.length ? (
          ...
          <div>
            <p className="mt-3 mb-5 text-[12px] text-gray-500">
              {"Step " + (activeStep + 1)}/2
            </p>
            <div
            ...
            >
              {activeStep !== 0 && (
                <Button
                  className="me-5 text-[14px] w-[9rem] btn btn-outline-secondary bg-gray-200 text-gray-800"
              ...
              <Button
                className="text-[14px] w-[9rem] btn btn-primary bg-primary"
                style={{ backgroundColor: "#00519D" }}
                onClick={handleNext}
              >
