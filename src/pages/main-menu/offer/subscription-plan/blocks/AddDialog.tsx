              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("offer.offerName", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("offer.offerCode", e.target.value)
                    }
                    disabled={isSubmitting}
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      const selected = serviceType.find(
                        (type) => type.servType.toString() === value,
                      );
                      handleInputChange("servType", value); // simpan ID
                      handleInputChange(
                        "servTypeName",
                        selected?.servTypeName || "",
                      ); // simpan label
                    }}
                    disabled={isSubmitting}
                  >
                    <SelectTrigger
                      className={`w-full border ${errors["servType"] ? "border-red-500" : "border-gray-300"}`}
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("offer.comments", e.target.value)
                    }
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("offer.effDate", e.target.value)
                    }
                    disabled={isSubmitting}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("offer.expDate", e.target.value)
                    }
                    disabled={isSubmitting}
                    className={errors["offer.expDate"] ? "border-red-500" : ""}
                  />
                  ...
                  <div className="flex gap-4 mt-2">
                    <label className="flex items-center text-sm">
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("paidFlag", e.target.value)
                        }
                        disabled={isSubmitting}
                        className="mr-2"
                      />
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleInputChange("brandPricePlanId", value)
                    }
                    disabled={isSubmitting}
                  >
                    <SelectTrigger>
