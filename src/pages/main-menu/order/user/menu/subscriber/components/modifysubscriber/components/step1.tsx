            ...
            .map((item, index) => {
              ...
              return (
                <div
                  ...
                  key={index}
                >
                  <div className=" px-5 items-center flex flex-row gap-2">
                    <KeenIcon
                      className="text-xl text-primary"
                      icon={
                        item.operationType === "X"
                          ? "files"
