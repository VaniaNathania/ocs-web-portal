          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <Select
                ...
                value={selectedTargetOfferType ?? undefined} onValueChange={handleSelectTargetOfferType}>
                <SelectTrigger>
            ...
            <div>
              ...
              >
                <PopoverTrigger asChild>
                  <button
                    type="button"
                    className={`w-full flex items-center justify-between px-3 py-2 border rounded-md hover:bg-gray-50 transition-colors ${errors.offerId ? "border-red-500" : "border-gray-300"
            ...
            <div>
              ...
              >
                <PopoverTrigger asChild>
                  <button
                    type="button"
                    className={`w-full flex items-center justify-between px-3 py-2 border rounded-md hover:bg-gray-50 transition-colors ${errors.relaType ? "border-red-500" : "border-gray-300"
                      } text-[13px] font-medium`}
                    disabled={loading}
                  >
                    <span className="truncate">
                    ...
                    <ChevronDown
                      className={`h-4 w-4 opacity-50 shrink-0 ml-2 transition-transform duration-200 ${relationTypeOpen ? "rotate-180" : ""
                        }`}
                    />
                  </button>
                </PopoverTrigger>
                    ...
                    <ul className="space-y-1 max-h-48 overflow-y-auto">
                      {filteredRelationTypes.map((item) => (
                        <li key={item.relaType}>
                          <button
                            type="button"
                            className={`flex w-full text-left px-3 py-2 rounded-md text-sm hover:bg-gray-100 ${selectedRelationType?.relaType === item.relaType
