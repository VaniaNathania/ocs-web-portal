...
// import { ExpressionPriceAcm } from "../../types";
...
interface Props {
  data: ExpressionPriceAcm | null;
  onChange: (data: ExpressionPriceAcm | null) => void;
  scriptToChange?: string;
}

const ExpressionPriceComponent: React.FC<Props> = ({
  data,
  onChange,
  scriptToChange,
}) => {
  ...
  const [formField, setFormField] = useState<ExpressionPriceAcm>({
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="text"
                  autoComplete="off"
                  value={formField.ruleComment ?? ""}
                  onChange={({ target }) => {
                    setFormField((prev) => ({
                      ...prev,
                      ruleComment: target.value,
                    }));
                  }}
                />
              </div>
...
export default ExpressionPriceComponent;