...
interface DeleteBenefitDialogProps {
  ...
  subBalTypeId: number | null; // GANTI KE INI
  onDeleteSuccess?: () => void;
}

const DeleteBenefitDialog: React.FC<DeleteBenefitDialogProps> = ({
  show,
  onClose,
  priceId,
  priceVersionId,
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await DeleteData(
        `${API_URL}/price/benefit/delete?priceId=${priceId}&priceVerId=${priceVersionId}&subBalTypeId=${subBalTypeId}`,
        {}
      );
...
export default DeleteBenefitDialog;
