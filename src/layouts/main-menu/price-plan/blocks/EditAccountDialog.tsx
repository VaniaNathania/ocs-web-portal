...
//   // Fetch service types
//   useEffect(() => {
//     if (!showEditAccountDialog || !selectedPricePlanId) return;
...
//     fetchAllType();
//   }, [showEditAccountDialog, selectedPricePlanId]);

//   // Set shouldFetch to true when dialog opens
//   useEffect(() => {
//     if (showEditAccountDialog && selectedPricePlanId) {
//       setShouldFetch(true);
//     }
//   }, [showEditAccountDialog, selectedPricePlanId]);
...
//     }
//   }, [showEditAccountDialog, reset]);

//   return (
//     <Dialog
//       open={showEditAccountDialog}
//       onOpenChange={(open) => handleEditAccountDialog(open)}
//     >
...
//             onClick={() => handleEditAccountDialog(false)}
//           ></Button>
//         </DialogHeader>
